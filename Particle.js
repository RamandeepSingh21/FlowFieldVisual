class Particle{
    ...
    Update(){
        ...
        Vector2.Add(this.acc, this.permanentForce);
        Vector2.Add(this.velocity, this.acc);        
        ...
        Vector2.Add(this.position, this.velocity);
        this.acc.SetVector(0, 0);
    }

    AddForce(force){

        Vector2.Add(this.acc, force);
    }
